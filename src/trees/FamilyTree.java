...
public class FamilyTree
{
    ...
    private static class TreeNode
    {
        ...
        TreeNode getNodeWithName(String targetName)
        {
            ...
            for (TreeNode child: children)
            {
            	...
            	TreeNode tn = getNodeWithName(targetName);
            	if (tn != null)
            	{
            		return child;
            	}
	...
	private void addLine(String line) throws TreeException
	{
		...
		if (colonIndex < 0)
			throw new TreeException("out of bounds"); // a TreeException with a useful message
		...
		else
		{
			...
			if (parentNode  == null)
			{
				throw new TreeException("error with data file");//There's a method in Node that searches for a named node. 
			}
	...
	TreeNode getMostRecentCommonAncestor(String name1, String name2) throws TreeException
	{
		...
		if (node1 == null)
			throw new TreeException("node1 not find");// with a useful message
